...
class RandomSurvivalForest:
    ...
    def __init__(self, n_estimators=100, min_leaf=3, unique_deaths=3,
        ...
        """
        A Random Survival Forest is a prediction base especially designed for survival analysis.
    ...
    def fit(self, x, y):
        ...
        trees = Parallel(n_jobs=self.n_jobs,
                         backend=self.parallelization_backend)(delayed(self.create_tree)(x, y, i)
